...
export default function Signup() {
  ...
  function validateImg(e){
    ...
    if(file.size > 1048576){
      return alert("Max file sixe is 1mb");
    }else{
      setImage(file);
    ...
    data.append('upload_preset', 'nzvreu5u');
    try{
      setUploadingImg(true);
      let res = await fetch('https://api.cloudinary.com/v1_1/dupr1fax6/image/upload',{
        method:'post',
        body:data
      });
        ...
        >
          <Form style={{ width: "80%", maxWidth: 500 }} onSubmit={handleSignup}> 
            ...
            <div className="signup-profile-pic__container">
              <img src={imagePreview || bot} className="signup-profile-pic" alt="dp" />
